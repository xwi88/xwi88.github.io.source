...
<div class="favirote-box">
	<div class="section" id="common_use">
		<div class="section-name"><strong>Common</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
				...
				<div class="item">
					<a href="https://code.visualstudio.com/" target="_blank" title="code editor">
	...
	<div class="section" id="official">
		<div class="section-name"><strong>Official</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
	...
	<div class="section" id="dev_need">
		<div class="section-name"><strong>Dev Picks</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
				...
				<div class="item">
					<a href="https://pyroscope.io/" target="_blank" title="open-source continuous profiling platform">
						<img src="/img/logo/pyroscope-logo.png" alt="pyroscope">
						<div class="item-name">Pyroscope</div>
					</a>
				</div>
				<div class="item">
					<a href="https://www.kafkatool.com/" target="_blank" title="kafka data viewer">
						<img src="/img/logo/kafka-tool-logo.jpeg" alt="kafkatool">
						<div class="item-name">kafkatool</div>
					</a>
				</div>
				<div class="item">
					<a href="https://dbeaver.io/" target="_blank" title="database tool, supports most databases">
	...
	<div class="section" id="community">
		<div class="section-name"><strong>Community</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
				...
				<div class="item">
					<a href="https://time.geekbang.org/" target="_blank" title="GeekTime">
	...
	<div class="section" id="online-book-reading">
		<div class="section-name"><strong>Books 📚</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
	...
	<div class="section" id="data-algo">
		<div class="section-name"><strong>Data &amp; Algo</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
				...
				<div class="item">
					<a href="https://pandas.pydata.org/" target="_blank" title="pandas official docs">
	...
	<div class="section" id="draw-tools">
		<div class="section-name"><strong>Diagramming</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
					<a href="https://www.processon.com/" target="_blank" title="online diagramming">
				...
				<div class="item">
					<a href="https://www.edrawsoft.cn/" target="_blank" title="powerful diagramming, multi-scenario">
	...
	<div class="section" id="online-tools">
		<div class="section-name"><strong>Online Tools</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
					<a href="https://docsmall.com/image-compress" target="_blank" title="image compression">
						<img src="/img/logo/docsmall-logo.png" alt="docsmall">
						<div class="item-name">docsmall</div>
					</a>
				</div>
				<div class="item">
					<a href="https://tinypng.com/" target="_blank" title="image compression">
					<img src="/img/logo/tinypng-logo.png" alt="tinypng" style="background-color:white;">
						<div class="item-name">tinypng</div>
					</a>
				</div>
				<div class="item">
					<a href="https://www.tablesgenerator.com/" target="_blank" title="table format conversion">
	...
	<div class="section" id="free-images">
		<div class="section-name"><strong>Free Images</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
					<a href="https://www.pexels.com/" target="_blank" title="free stock photos - pexels">
	...
	<div class="section" id="quick-link">
		<div class="section-name"><strong>Quick Links</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
					<a href="https://studygolang.com/" target="_blank" title="Go directory">
						<img src="/img/logo/hao-studygolang-logo.png" alt="hao.studygolang">
						<div class="item-name">Go Directory</div>
					</a>
				</div>
				<div class="item">
					<a href="https://github.com/sindresorhus/awesome" target="_blank" title="awesome source">
	...
	<div class="section" id="others">
		<div class="section-name"><strong>Others</strong></div>
		<div class="items">
			<div class="row">
				<div class="item">
