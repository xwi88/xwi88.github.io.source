...
<div class="favirote-box">
	<div class="section" id="common_use">
		...
		<div class="items">
			<div class="row">
				...
				<div class="item">
					<a href="https://code.visualstudio.com/" target="_blank" rel="noopener noreferrer" title="代码神器">
						<img src="/img/logo/vscode-logo.png" alt="visualstudio" loading="lazy">
						<div class="item-name">VS Code</div>
					</a>
				</div>
				<div class="item">
					<a href="https://github.com/golang/go/wiki" target="_blank" rel="noopener noreferrer" title="go wiki">
						<div class="item-name" style="margin-left: -8px;">Go Wiki</div>
					</a>
				</div>
				<div class="item">
					<a href="https://awesome-go.com/" target="_blank" rel="noopener noreferrer" title="awesome-go">
	...
	<div class="section" id="dev_need">
		...
		<div class="items">
			<div class="row">
				...
				<div class="item">
					<a href="https://pyroscope.io/" target="_blank" rel="noopener noreferrer" title="开源的持续性能数据收集分析平台">
						<img src="/img/logo/pyroscope-logo.png" alt="pyroscope" loading="lazy">
						<div class="item-name">Pyroscope</div>
					</a>
				</div>
				<div class="item">
					<a href="https://www.kafkatool.com/" target="_blank" rel="noopener noreferrer" title="kafka 数据查看工具">
						<img src="/img/logo/kafka-tool-logo.jpeg" alt="kafkatool" loading="lazy">
						<div class="item-name">kafkatool</div>
					</a>
				</div>
				<div class="item">
					<a href="https://dbeaver.io/" target="_blank" rel="noopener noreferrer" title="database tool 支持大部分数据库">
			...
			<div class="row">
				<div class="item">
					<a href="https://leetcode-cn.com/" target="_blank" rel="noopener noreferrer" title="leetcode-cn.com">
						<img src="/img/logo/leetcode-logo.jpeg" alt="力扣" loading="lazy">
				...
				<div class="item">
					<a href="https://time.geekbang.org/" target="_blank" rel="noopener noreferrer" title="极客时间">
	...
	<div class="section" id="data-algo">
		...
		<div class="items">
			<div class="row">
				...
				<div class="item">
					<a href="https://pandas.pydata.org/" target="_blank" rel="noopener noreferrer" title="pandas 官方文档">
	...
	<div class="section" id="draw-tools">
		...
		<div class="items">
			<div class="row">
				<div class="item">
					<a href="https://www.processon.com/" target="_blank" rel="noopener noreferrer" title="在线绘图">
				...
				<div class="item">
					<a href="https://www.edrawsoft.cn/" target="_blank" rel="noopener noreferrer" title="国产绘图神器，多场景支持">
	...
	<div class="section" id="online-tools">
		...
		<div class="items">
			<div class="row">
				<div class="item">
					<a href="https://docsmall.com/image-compress" target="_blank" rel="noopener noreferrer" title="图片压缩">
						<img src="/img/logo/docsmall-logo.png" alt="图片压处理" loading="lazy">
						<div class="item-name">docsmall</div>
					</a>
				</div>
				<div class="item">
					<a href="https://tinypng.com/" target="_blank" rel="noopener noreferrer" title="图片压缩">
					<img src="/img/logo/tinypng-logo.png" alt="图片压处理" loading="lazy" style="background-color:white;">
						<div class="item-name">tinypng</div>
					</a>
				</div>
				<div class="item">
					<a href="https://www.tablesgenerator.com/" target="_blank" rel="noopener noreferrer" title="tables 格式转换">
	...
	<div class="section" id="free-images">
		...
		<div class="items">
			<div class="row">
				<div class="item">
					<a href="https://www.pexels.com/" target="_blank" rel="noopener noreferrer" title="免费图库 pexels">
	...
	<div class="section" id="quick-link">
		...
		<div class="items">
			<div class="row">
				<div class="item">
					<a href="https://studygolang.com/" target="_blank" rel="noopener noreferrer" title="Go网址导航">
						<img src="/img/logo/hao-studygolang-logo.png" alt="hao.studygolang" loading="lazy">
						<div class="item-name">Go网址导航</div>
					</a>
				</div>
				<div class="item">
					<a href="https://github.com/sindresorhus/awesome" target="_blank" rel="noopener noreferrer" title="awesome sourcce">
