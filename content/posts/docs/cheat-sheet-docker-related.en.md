...
description: "A cheat-sheet reference for docker-related commands"
...
A cheat-sheet reference for Docker-related commands, focused on the [Docker CLI](https://docs.docker.com/engine/reference/commandline/cli/) and [Compose CLI](https://docs.docker.com/compose/compose-file/).
<!--more-->
...
- `docker images` **[list images](#docker-image-filtering)**
- `docker login`
- `docker search`
- `docker tag`
- `docker pull`
